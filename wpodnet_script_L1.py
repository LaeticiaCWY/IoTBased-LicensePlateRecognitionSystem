...
db.child("/lpr/YOLO_url").remove("/lpr/YOLO_url")
print("URL deleted successfully.")  

db.child("/lpr/WPOD-NET_url").remove("/lpr/WPOD-NET_url")
print("URL deleted successfully.")  
...
storage_path = "lpr/YOLO.jpg"
storage.child(storage_path).put (r'C:\Users\Laeticia\Vehicle-Detection\vehicle_images\test\images\1_vehicle_0.jpg')
db_path = "/lpr/YOLO_url"
image_url = storage.child("lpr/YOLO.jpg").get_url(None)
db.child(db_path).set(image_url)
metadata = {'cacheControl': 'no-cache'}  # Customize this value as needed
...
storage_path = "lpr/WPOD-NET.jpg"
storage.child(storage_path).put (r'C:\Users\Laeticia\Vehicle-Detection\sample_license_plate.jpg')
db_path = "/lpr/WPOD-NET_url"
image_url = storage.child("lpr/WPOD-NET.jpg").get_url(None)
db.child(db_path).set(image_url)
metadata = {'cacheControl': 'no-cache'}  # Customize this value as needed
...
def check_plate_number(word):
    try:
        ...
        connection = mysql.connector.connect(
            ...
            user="root",
            passwd="4Glades10!",
            database="VehicleID"  # Replace with your database name
        )
        ...
        select_query = "SELECT Vehicle_No_Plate FROM VehicleID WHERE Vehicle_No_Plate = %s"
